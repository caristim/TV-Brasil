// Lista de canales (todas las URLs HTTPS)
const channels = [
    {
        name: "Globo",
    ...
    {
        name: "Band",
        logoSvg: `<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="100" fill="#1a1a1a"/><text x="100" y="65" font-family="Arial Black" font-size="50" fill="#00aaff" text-anchor="middle">BAND</text></svg>`,
        streamUrl: "https://cdn.live.br1.vusioncloud.net/live/band-com-br/master.m3u8"
    },
    {
        name: "SBT",
        logoSvg: `<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="100" fill="#0066cc"/><text x="100" y="65" font-family="Arial Black" font-size="50" fill="white" text-anchor="middle">SBT</text></svg>`,
        streamUrl: "https://cdnlive.sbt.com.br/live/sbt/playlist.m3u8"
    },
    {
        name: "Record",
        logoSvg: `<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="100" fill="#cc0000"/><text x="100" y="65" font-family="Arial Black" font-size="40" fill="white" text-anchor="middle">RECORD</text></svg>`,
        streamUrl: "https://cdn.jmvstream.com/w/LVW-10842/playlist.m3u8"
    },
    {
        name: "RedeTV!",
        logoSvg: `<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="100" fill="#ffcc00"/><text x="100" y="60" font-family="Arial Black" font-size="35" fill="#000" text-anchor="middle">RedeTV!</text></svg>`,
        streamUrl: "https://tv02.redetv.com.br/live/index.m3u8"
    },
    {
        name: "TV Brasil",
        logoSvg: `<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="100" fill="#009639"/><text x="100" y="45" font-family="Arial Black" font-size="28" fill="#ffdf00" text-anchor="middle">TV</text><text x="100" y="75" font-family="Arial Black" font-size="28" fill="#ffdf00" text-anchor="middle">BRASIL</text></svg>`,
...
function handleError(details) {
    ...
    if (details === 'manifestLoadError' || details === 'manifestParsingError') {
        ...
        if (currentChannelName === 'Globo' || currentChannelName === 'Band' || currentChannelName === 'SBT') {
    ...
    // Si es un error de región, mostrar botón de reintento con sugerencia
    if (isRegionBlock) {
        // Mostrar botón de reintento con mensaje adicional
    }
    showRetryButton();
}
